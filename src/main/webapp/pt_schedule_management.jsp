...
import="Models.Schedule, java.util.List" %> <%@ taglib prefix="c"
          ...
          <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
              ...
              <div class="d-flex gap-2">
                <a
                  href="${pageContext.request.contextPath}/pt_dashboard.jsp"
                  class="btn btn-outline-white btn-sm"
                >
                  <i class="fas fa-arrow-left me-2"></i>Quay lại Dashboard
                </a>
                <a
                  href="${pageContext.request.contextPath}/pt-add-schedule.jsp"
                    ...
                    <tbody>
                      <c:forEach var="schedule" items="${schedules}">
                        <tr>
                          ...
                          <td>
                            <span
                              class="badge badge-sm ${schedule.status == 'Completed' ? 'bg-gradient-success' : schedule.status == 'Confirmed' ? 'bg-gradient-info' : schedule.status == 'Cancelled' ? 'bg-gradient-danger' : 'bg-gradient-warning'}"
                            >
                              ${schedule.status}
                            </span>
                          </td>
                          <td>
                            <a
                              href="${pageContext.request.contextPath}/pt_schedule_members.jsp?scheduleId=${schedule.id}"
                              class="btn btn-link text-dark px-3 mb-0"
                            >
                              <i class="fas fa-eye text-secondary me-2"></i>Chi
                              tiết
                            </a>
                            <a
                              href="${pageContext.request.contextPath}/pt_member_progress.jsp?scheduleId=${schedule.id}"
                              class="btn btn-link text-dark px-3 mb-0"
                            >
