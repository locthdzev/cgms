...
import="Models.User"%> <% User loggedInUser = (User)
session.getAttribute("loggedInUser"); if (loggedInUser == null) {
response.sendRedirect("login.jsp"); return; } // Xử lý thông báo String
successMessage = (String) session.getAttribute("successMessage"); String
errorMessage = (String) session.getAttribute("errorMessage"); boolean
hasSuccessMessage = successMessage != null && !successMessage.trim().isEmpty();
boolean hasErrorMessage = errorMessage != null &&
!errorMessage.trim().isEmpty(); if (hasSuccessMessage)
session.removeAttribute("successMessage"); if (hasErrorMessage)
    ...
    <main class="main-content position-relative border-radius-lg">
              ...
              >
                ...
                <div>
                  <button
                    ...
                    data-bs-target="#sendFeedbackModal"
                  >
                  ...
                  <button
                    ...
                    data-bs-toggle="modal"
                    data-bs-target="#sendScheduleFeedbackModal"
                  >
                      ...
                      <tbody>
                        <c:forEach var="fb" items="${memberFeedbacks}">
                          <tr>
                              ...
                              <div class="d-flex px-2 py-1">
                                ...
                                >
                                  <h6 class="mb-0 text-sm">
                                    <c:choose>
                                      <c:when
                                        test="${fn:length(fb.content) > 50}"
                                      >
                                        ${fn:substring(fb.content, 0, 50)}...
                                      </c:when>
                                      <c:otherwise> ${fb.content} </c:otherwise>
                                    </c:choose>
                                  </h6>
                              ...
                              >
                                <c:if test="${not empty fb.createdAt}">
                                  ...
                                  <jsp:setProperty
                                    name="createdDate"
                                    property="time"
                                    value="${fb.createdAt.toEpochMilli()}"
                                  />
                                  <fmt:formatDate
                                    value="${createdDate}"
                            ...
                            <td class="text-center">
                              <button
                                class="btn btn-sm btn-outline-info view-detail-btn"
                                data-id="${fb.id}"
      ...
      <div class="modal fade" id="sendFeedbackModal" tabindex="-1">
        <div class="modal-dialog">
          <form
            action="${pageContext.request.contextPath}/member-feedback"
            method="post"
            class="modal-content"
          >
            ...
            <div class="modal-body">
                ...
                >
                  ...
                  <c:forEach var="schedule" items="${completedSchedules}">
                    <option value="${schedule.id}">
                      Buổi #${schedule.id} - ${schedule.scheduleDate} -
              ...
              <div class="mb-3">
                ...
                <textarea
                  ...
                  name="content"
                  rows="4"
                  placeholder="Chia sẻ cảm nhận về buổi tập này..."
                  required
                ></textarea>
              </div>
            </div>
              ...
              <div class="row">
                <div class="col-md-12 mb-3">
                  <div class="d-flex align-items-center">
                    <div
                      class="avatar avatar-xl rounded-circle bg-gradient-primary me-3 d-flex align-items-center justify-content-center"
                    >
                  ...
                  <div class="card border-0 bg-gradient-light">
                    <div class="card-body">
                      <div class="d-flex align-items-center mb-3">
                        <div
                          class="avatar avatar-sm rounded-circle bg-gradient-success me-3 d-flex align-items-center justify-content-center"
                        >
