...
<html lang="en">
  ...
  <body class="g-sidenav-show bg-gray-100">
          ...
          <div class="col-12">
            <div class="card shadow-lg">
              ...
              <div class="card-body">
                ...
                <form
                  action="${pageContext.request.contextPath}/pt_schedule/create"
                  method="post"
                >
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="memberId" class="form-control-label"
                          >Hội viên <span class="text-danger">*</span></label
                        >
                        <select
                          class="form-control"
                          id="memberId"
                        ...
                        >
                          ...
                          <c:forEach var="member" items="${members}">
                            <option
                              value="${member.id}"
                              title="Email: ${member.email} - Có gói tập hiện tại"
                            >
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="scheduleDate" class="form-control-label"
                          >Ngày tập <span class="text-danger">*</span></label
                        >
                        <input
                          class="form-control"
                          type="date"
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="scheduleTime" class="form-control-label"
                          >Thời gian bắt đầu
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="durationHours" class="form-control-label"
                          >Thời lượng <span class="text-danger">*</span></label
                        >
                        <select
                          class="form-control"
                          id="durationHours"
    ...
    <script>
      ...
      document.getElementById("scheduleDate").min = new Date()
        .toISOString()
        .split("T")[0];
    </script>
  </body>
