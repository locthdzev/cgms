...
loggedInUser = (User) session.getAttribute("loggedInUser"); // Kiểm tra xem
người dùng đã đăng nhập và có vai trò Member không if (loggedInUser == null ||
!"Member".equals(loggedInUser.getRole())) { response.sendRedirect("login");
return; } // Lấy thông báo từ session nếu có String successMessage = (String)
session.getAttribute("successMessage"); if (successMessage != null) {
session.removeAttribute("successMessage"); } String errorMessage = (String)
session.getAttribute("errorMessage"); if (errorMessage != null) {
session.removeAttribute("errorMessage"); } // Đặt tiêu đề trang cho navbar
              ...
              <div class="card-body p-3">
                <div class="row">
                  <div class="col-lg-6">
                    <div class="d-flex">
                      <div
                        class="avatar avatar-xl bg-gradient-primary rounded-circle"
                      >
                        <i
                          class="fas fa-user text-white position-relative"
                          style="font-size: 24px; top: 10px; left: 12px"
                        ></i>
                      </div>
                      <div class="ms-3">
                        <h5 class="mb-0">
                  ...
                  <div
                    class="col-lg-6 text-end d-flex align-items-center justify-content-end"
                  >
                    <a
                      href="member-schedule.jsp"
              ...
              <div class="card-body p-3">
                <div class="row">
                  ...
                  <div class="col-4 text-end">
                    ...
                    >
                      <i
                        class="fas fa-check-circle text-lg opacity-10"
                        aria-hidden="true"
                      ></i>
                    </div>
                  </div>
              ...
              <div class="card-body p-3">
                <div class="row">
                  ...
                  <div class="col-4 text-end">
                    ...
                    >
                      <i
                        class="fas fa-calendar-alt text-lg opacity-10"
                        aria-hidden="true"
                      ></i>
                    </div>
                  </div>
                ...
                <div class="row">
                  <div class="col-8">
                    <div class="numbers">
                      ...
                      <h5 class="font-weight-bolder mb-0">150</h5>
                    </div>
                  </div>
                  <div class="col-4 text-end">
                    <div
                    ...
                    >
                      <i
                        class="fas fa-star text-lg opacity-10"
                        aria-hidden="true"
                      ></i>
                    </div>
                  </div>
            ...
            <div class="card membership-card z-index-2 h-100">
              <div class="card-body p-3">
                ...
                <div class="d-flex justify-content-between mt-4">
                  <a
                    href="member-packages-controller"
              ...
              <div class="card-body p-3">
                <div class="activity-item">
                  ...
                  <div class="activity-content">
                    ...
                    <div class="activity-description text-sm">
                      Bạn đã hoàn thành buổi tập với PT Nguyễn Văn A
                    </div>
                ...
                <div class="activity-item">
                  ...
                  <div class="activity-content">
                    ...
                    <div class="activity-description text-sm">
                      Bạn đã đặt lịch tập với PT Nguyễn Văn A
                    </div>
                ...
                <div class="activity-item">
                  ...
                  <div class="activity-content">
                    ...
                    <div class="activity-description text-sm">
                      Bạn đã nhận 50 điểm thưởng từ việc check-in liên tục 5
                      ngày
                    </div>
            ...
            <div class="card">
              ...
              <div class="card-body p-3">
                <div class="d-flex mb-3">
                  <img
                    src="assets/img/products/whey-protein.jpg"
                    alt="Whey Protein"
                ...
                <div class="d-flex mb-3">
                  <img
                    src="assets/img/products/bcaa.jpg"
                    alt="BCAA"
                    class="border-radius-lg shadow"
                    style="width: 80px; height: 80px; object-fit: cover"
                  />
                ...
                <div class="d-flex">
                  <img
                    src="assets/img/products/shaker.jpg"
                    alt="Shaker"
                    class="border-radius-lg shadow"
                    style="width: 80px; height: 80px; object-fit: cover"
                  />
