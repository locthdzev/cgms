...
người dùng đã đăng nhập và có vai trò Personal Trainer không if (loggedInUser ==
null || !"Personal Trainer".equals(loggedInUser.getRole())) {
response.sendRedirect("login"); return; } // Lấy thông báo từ session nếu có
String successMessage = (String) session.getAttribute("successMessage"); if
(successMessage != null) { session.removeAttribute("successMessage"); } String
errorMessage = (String) session.getAttribute("errorMessage"); if (errorMessage
!= null) { session.removeAttribute("errorMessage"); } %>
<!DOCTYPE html>
<html lang="en" itemscope itemtype="http://schema.org/WebPage">
  ...
  <body class="g-sidenav-show bg-gray-100">
              ...
              <div class="card-body p-3">
                <div class="row">
                  ...
                  <div class="col-4 text-end">
                    ...
                    >
                      <i
                        class="fas fa-calendar text-lg opacity-10"
                        aria-hidden="true"
                      ></i>
                    </div>
                  </div>
              ...
              <div class="card-body p-3">
                <div class="row">
                  ...
                  <div class="col-4 text-end">
                    ...
                    >
                      <i
                        class="fas fa-users text-lg opacity-10"
                        aria-hidden="true"
                      ></i>
                    </div>
                  </div>
                ...
                <div class="d-flex justify-content-between align-items-center">
                  ...
                  <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="monthDropdown">
                      <li>
                        <a class="dropdown-item" href="#">Tháng 5/2024</a>
                      </li>
                      <li>
                        <a class="dropdown-item" href="#">Tháng 6/2024</a>
                      </li>
                      <li>
                        <a class="dropdown-item" href="#">Tháng 7/2024</a>
                      </li>
                    </ul>
                  </div>
                </div>
    ...
    ></script>
    <script
      src="assets/js/argon-dashboard.min.js?v=2.1.0"
      type="text/javascript"
    ></script>
    ...
    <script>
      document.addEventListener("DOMContentLoaded", function () {
        ...
        var workScheduleCtx = document
          .getElementById("workScheduleChart")
          .getContext("2d");
        ...
        var clientGoalsCtx = document
          .getElementById("clientGoalsChart")
          .getContext("2d");
        ...
        var weeklyScheduleCtx = document
          .getElementById("weeklyScheduleChart")
          .getContext("2d");
        ...
        var clientProgressCtx = document
          .getElementById("clientProgressChart")
          .getContext("2d");
