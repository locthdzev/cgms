...
import="Models.User"%> <%@page import="Models.Voucher"%> <%@page
import="java.util.List"%> <%@page import="java.time.format.DateTimeFormatter"%>
<% // Lấy thông tin người dùng đăng nhập từ session User loggedInUser = (User)
session.getAttribute("loggedInUser"); List<Voucher>
  vouchers = (List<Voucher
    >) request.getAttribute("vouchers"); // Lấy thông báo từ request hoặc
    session String successMessage = (String)
    request.getAttribute("successMessage"); if (successMessage == null) {
    successMessage = (String) session.getAttribute("successMessage"); if
    (successMessage != null) { session.removeAttribute("successMessage"); } }
    String errorMessage = (String) request.getAttribute("errorMessage"); if
    (errorMessage == null) { errorMessage = (String)
    session.getAttribute("errorMessage"); if (errorMessage != null) {
    session.removeAttribute("errorMessage"); } } boolean hasSuccessMessage =
    successMessage != null; boolean hasErrorMessage = errorMessage != null; //
    Định dạng ngày tháng DateTimeFormatter dateFormatter =
    ...
    <html lang="en" itemscope itemtype="http://schema.org/WebPage">
      <head>
        ...
        <link
          ...
          sizes="76x76"
          href="${pageContext.request.contextPath}/assets/img/icons8-gym-96.png"
        />
        <link
          rel="icon"
          type="image/png"
        ...
        <link
          id="pagestyle"
          href="${pageContext.request.contextPath}/assets/css/argon-dashboard.css?v=2.1.0"
          rel="stylesheet"
        />
        <style>
          .user-welcome {
      ...
      <body class="g-sidenav-show bg-gray-100">
            ...
            <div class="card mb-4">
              ...
              >
                ...
                <div>
                  ...
                  <a
                    href="${pageContext.request.contextPath}/voucher?action=create"
                    ...
                    <tbody>
                      <c:forEach var="v" items="${voucherList}">
                        <tr>
                          ...
                          <td class="ps-2">
                            <h6 class="mb-0 text-sm">${v.code}</h6>
                          </td>
                          <td class="ps-2">
                          ...
                          <td class="ps-2">
                            <h6 class="mb-0 text-sm">${v.expiryDate}</h6>
                          </td>
                          <td class="ps-2">
                            <c:choose>
                            ...
                            <div class="dropdown">
                              ...
                              <ul class="dropdown-menu dropdown-menu-end">
                                <li>
                                  <a
                                    class="dropdown-item"
                                    href="${pageContext.request.contextPath}/voucher?action=edit&id=${v.id}"
                                ...
                                <li>
                                  <a
                                    class="dropdown-item view-voucher-btn"
                                    href="#"
                                    data-id="${v.id}"
                                    data-code="${v.code}"
                                ...
                                <li>
                                  <a
                                    class="dropdown-item delete-voucher-btn delete-action"
                                    href="#"
                                    data-id="${v.id}"
                                    data-code="${v.code}"
                                    ><i class="fas fa-trash me-2"></i>Xóa</a
                                  >
                                </li>
                              </ul>
                            </div>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <p>
                  ...
                  <span id="voucherCode" class="fw-bold"></span>?
                </p>
        ...
        <div
          ...
          tabindex="-1"
          aria-labelledby="voucherDetailModalLabel"
          aria-hidden="true"
        >
          <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="voucherDetailModalLabel">
                  Chi tiết Voucher
                </h5>
                <button
                  type="button"
              ...
              <div class="modal-body">
                <div class="row">
                  <div class="col-md-5 mb-3">
                    <img
                      src="assets/svg/voucher-discount.svg"
                      class="img-fluid voucher-detail-img"
                      id="voucherDetailImage"
                      alt="Voucher Image"
                    />
                  </div>
                  <div class="col-md-7">
                    ...
                    <div class="mb-2">
                      <span class="detail-label"
                        >Giá trị đơn hàng tối thiểu:</span
                      >
                      <span id="voucherDetailMinPurchase" class="ms-2"></span>
                      VNĐ
                    </div>
                    <div class="mb-2">
              ...
              <div class="modal-footer">
                ...
                <a href="#" id="editVoucherBtn" class="btn btn-primary"
                  >Chỉnh sửa</a
                >
              </div>
            </div>
        ...
        <script>
          document.addEventListener("DOMContentLoaded", function () {
            ...
            document
              .querySelectorAll(".delete-voucher-btn")
              .forEach(function (button) {
                button.addEventListener("click", function () {
                  ...
                  document.getElementById("confirmDeleteBtn").href =
                    "${pageContext.request.contextPath}/voucher?action=delete&id=" +
                    id;
            ...
            document
              .querySelectorAll(".view-voucher-btn")
              .forEach(function (button) {
                button.addEventListener("click", function (e) {
                  ...
                  document.getElementById("voucherDetailCode").textContent =
                    code;
                  ...
                  if (type === "Percent") {
                    ...
                    ).textContent = formatNumber(discount) + "%";
                    document.getElementById("voucherDetailType").textContent =
                      "Phần trăm";
                  } else {
                    document.getElementById(
                      "voucherDetailDiscount"
                  ...
                  document.getElementById(
                    "voucherDetailMinPurchase"
                  ).textContent = new Intl.NumberFormat("vi-VN").format(
                    formatNumber(minPurchase)
                  );
                  document.getElementById("voucherDetailExpiry").textContent =
                    formatDate(expiry);
                  document.getElementById("voucherDetailCreated").textContent =
                    formatDateWithTime(created) || "N/A";
                  document.getElementById("voucherDetailUpdated").textContent =
                    formatDateWithTime(updated) || "N/A";
                  ...
                  document.getElementById("editVoucherBtn").href =
                    "${pageContext.request.contextPath}/voucher?action=edit&id=" +
                    id;
