...
import="Models.Inventory" %> <%@ page import="Models.Product" %> <%@ taglib
  ...
  <body class="g-sidenav-show bg-gray-100">
    ...
    <main class="main-content position-relative border-radius-lg">
      ...
      <jsp:include page="navbar.jsp">
        <jsp:param name="pageTitle" value="Cập nhật số lượng tồn kho" />
        <jsp:param name="parentPage" value="Quản lý kho hàng" />
        <jsp:param name="parentPageUrl" value="inventory" />
        <jsp:param name="currentPage" value="Cập nhật số lượng tồn kho" />
      </jsp:include>
