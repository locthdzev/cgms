...
import="Models.Inventory" %> <%@ page import="Models.Product" %> <%@ page
          ...
          <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
              ...
              <div class="d-flex gap-2">
                ...
                <a
                  href="${pageContext.request.contextPath}/inventory?action=add"
                    ...
                    <tbody>
                      <c:forEach var="inventory" items="${inventoryList}">
                        <tr>
                          ...
                          <td>
                            <span
                              class="badge badge-sm ${inventory.quantity > 0 ? 'bg-gradient-success' : 'bg-gradient-danger'}"
                            >
                              ${inventory.quantity > 0 ? 'Còn hàng' : 'Hết
                              hàng'}
                            </span>
                          </td>
                          <td>
                            <a
                              href="${pageContext.request.contextPath}/inventory?action=edit&productId=${inventory.product.id}"
