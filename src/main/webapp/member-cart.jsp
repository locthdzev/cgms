...
import="Models.User"%> <%@page import="Models.Cart"%> <%@page
import="java.util.List"%> <% User loggedInUser = (User)
session.getAttribute("loggedInUser"); if (loggedInUser == null ||
!"Member".equals(loggedInUser.getRole())) { response.sendRedirect("login");
return; } List<Cart>
  cartItems = (List<Cart
    >) request.getAttribute("cartItems"); String successMessage = (String)
      ...
      <body class="g-sidenav-show bg-gray-100">
        ...
        <script>
          ...
          function updateSelectedTotal() {
            ...
            document.querySelector(".cart-checkout-btn").disabled =
              document.querySelectorAll(".select-cart-item:checked").length ===
              0;
          }
