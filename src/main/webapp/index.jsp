...
<html lang="en" itemscope itemtype="http://schema.org/WebPage">
  ...
  <body class="presentation-page">
                        ...
                        >
                          ...
                          >
                            <div class="d-flex">
                              <div class="icon h-10 me-3 d-flex mt-1">
                                <i
                                  class="ni ni-badge text-gradient text-primary"
                                ></i>
                              </div>
                              <div
                                class="w-100 d-flex align-items-center justify-content-between"
                        ...
                        >
                          ...
                          >
                            <div class="d-flex">
                              <div class="icon h-10 me-3 d-flex mt-1">
                                <i
                                  class="ni ni-app text-gradient text-primary"
                                ></i>
                              </div>
                              <div
                                class="w-100 d-flex align-items-center justify-content-between"
                            ...
                            >
                              <div class="d-flex">
                                ...
                                <div>
                                  ...
                                  <span class="text-sm"
                                    >Check how you can integrate our
                                    plugins</span
                                  >
                                </div>
                              </div>
                            ...
                            >
                              <div class="d-flex">
                                ...
                                <div>
                                  ...
                                  <span class="text-sm"
                                    >For those who want flexibility, use our
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-7 text-center mx-auto">
              <h1 class="text-white pt-3 mt-n5 text-dark">
                CoreFit Gym Management System
              </h1>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-4">
          <div class="info-horizontal bg-primary border-radius-xl p-5">
            <div class="icon">
              <svg
                class="text-white"
                width="25px"
                ...
                >
                  ...
                  >
                    <g transform="translate(1716.000000, 291.000000)">
                      <g
                        id="delivery-fast"
                        transform="translate(604.000000, 450.000000)"
                      >
                        <rect
                          class="color-background"
                          opacity="0.601143973"
          ...
          <div class="info-horizontal bg-gray-100 border-radius-xl p-5">
            ...
            <div class="description ps-5">
              ...
              <p>
                ...
                used to create the Soft UI Design System.
              </p>
          ...
          <div class="info-horizontal bg-gray-100 border-radius-xl p-5">
            <div class="icon">
              ...
              >
                ...
                >
                  <g
                    transform="translate(-2170.000000, -442.000000)"
                    fill="#FFFFFF"
                    fill-rule="nonzero"
                  >
                    <g transform="translate(1716.000000, 291.000000)">
            ...
            <div class="description ps-5">
              ...
              <p>
                Soft UI Design System is giving you a lot of pre-made elements.
                For those who want flexibility, we included many utility
                classes.
              </p>
              <a href="" class="text-primary icon-move-right">
                Read more
          ...
          <div class="col-lg-4 col-md-8">
            <div class="card card-plain">
              <div class="card-body">
                ...
                <p class="mt-4">
                  "Great product. Helped me cut the time to set up a site. I
        ...
        <div class="row">
          <div class="col-md-7 col-12 my-auto">
            ...
            <p class="pe-md-5 mb-4">
              Most complex and innovative Design System Made by
              <a href="https://creative-tim.com/" target="_blank"
                >Creative Tim
              </a>
              . Check our latest Premium Bootstrap 5 UI Kit. Designed for those
              who like bold elements and beautiful websites. Made of hundred of
              elements, designed blocks and fully coded pages, Soft UI Design
              System is ready to help you create stunning websites and webapps.
            </p>
            <div class="github-buttons">
              <a
                ...
                target="_blank"
                rel="nofollow"
                class="btn btn-primary mb-5 mb-sm-0"
                >Upgrade to Pro</a
              >
