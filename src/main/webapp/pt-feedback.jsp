...
<html lang="en">
  ...
  <body class="g-sidenav-show bg-gray-100">
    ...
    >
      <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="#">
          <img
            src="./assets/img/icons8-gym-96.png"
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a
              ...
              href="${pageContext.request.contextPath}/pt-feedback"
            >
              <div
                class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center"
              >
    ...
    <main class="main-content position-relative border-radius-lg">
      <!-- Navbar -->
      <nav
        class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl bg-transparent"
        id="navbarBlur"
      >
        <div class="container-fluid py-1 px-3">
          <nav aria-label="breadcrumb">
            ...
            >
              <li class="breadcrumb-item text-sm text-white opacity-5">
                Pages
              </li>
              <li
