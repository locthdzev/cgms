...
import="Models.Package"%> <%@page import="Utilities.VNDUtils"%> <% // Lấy thông
tin gói tập cần chỉnh sửa Package pkg = (Package)
...
<html lang="en" itemscope itemtype="http://schema.org/WebPage">
  ...
  <body class="g-sidenav-show bg-gray-100">
    ...
    <main class="main-content position-relative border-radius-lg">
      ...
      <% if (pkg == null) {
      response.sendRedirect("listPackage?error=Không+tìm+thấy+gói+tập"); return;
      } %>
                ...
                <form action="editPackage" method="post">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                      ...
                      name="sessions" value="<%= pkg.getSessions() != null ?
                      pkg.getSessions() : "" %>">
                    </div>
                  </div>
                  <div class="mb-3">
                    ...
                    <textarea
                      ...
                      rows="3"
                    >
<%= pkg.getDescription() != null ? pkg.getDescription() : "" %></textarea
                    >
                  </div>
                  <div class="mb-3">
                    ...
                    <small class="text-muted"
                      >Trạng thái chỉ có thể thay đổi từ trang danh sách gói
                      tập</small
                    >
                  </div>
